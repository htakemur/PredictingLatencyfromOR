...
% (1) Perform prediction for C1 peak latency from optic radiation data with
% leave-one-out cross validation. 
% (2) Create scatter plot between Measured and Predicted C1 peak latency. 
% This script aims to reproduce Figure 4B in a following article: 
...
latency_test = nanmedian(latency_v1_HCD,1);
