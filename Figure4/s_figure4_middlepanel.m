...
% Sort C1 peak latency data and collect data from low contrast, lower
% visual field condition
for kk = 1:20
    latency_v1_LCD(1,kk) = latency_v1(2,kk); %Left LVF, low contrast
    latency_v1_LCD(2,kk) = latency_v1(4,kk); %Right LVF, low contrast  
end

% Average latency across left and right visual fie;d
latency_test = nanmedian(latency_v1_LCD,1);
